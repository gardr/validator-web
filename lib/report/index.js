...
var getTmpDir = require('./lib/tmpDir.js');
...
var options = {
    ...
    validators: {
        ...
        codeUsage: resolve('lib/report/validator/codeUsage.js'),
    },
    pageRunTime: 10000
};
...
module.exports = function (data, callback) {
    ...
    opts.userAgent  = data.userAgent;
    opts.options    = data.options;
    opts.outputDirectory = getTmpDir(opts.id);
    if (data.viewport ){
        opts.width  = data.viewport.width;
        opts.height = data.viewport.height;
    }
    log.info('validator processing', opts.id, 'output to', opts.outputDirectory, '. Spawning in ', opts.width, 'x', opts.height);
